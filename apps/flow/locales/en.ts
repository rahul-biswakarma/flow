export default {
  ...
  "component_builder.wrong_transformed_code":
  ...
  "component_library.component_count": "{count} components",
  "component_library.search_placeholder": "Search components...",
  "component_library.empty_state": "No components found",
  "component_library.create_first": "Create your first component",
  "component_library.tabs.drafts": "Drafts",
  "component_library.tabs.published": "Published",
  "component_library.error_loading": "Error loading components",
  "component_library.usage_count": "Used {count} times",
  "component_library.last_used": "Last used {time} ago",
  "component_library.actions.edit": "Edit",
  "component_library.actions.duplicate": "Duplicate",
  "component_library.actions.delete": "Delete",
